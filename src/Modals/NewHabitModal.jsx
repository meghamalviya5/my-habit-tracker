...
console.log("in add habits modal");

const NewHabitModal = ({ setModal }) => {
  //   return <div>NewHabitModal</div>;
  // close the modal when clicking outside the modal.
  const modalRef = useRef();
  const closeModal = (e) => {
    if (e.target === modalRef.current) {
      setModal((prevState) => ({ ...prevState, newHabitModal: false }));
    }
  };

  const { state, dispatch, handleSave } = useContext(HabitContext);
        ...
        <form>
          ...
          <div>
            ...
            <select
              ...
              value={state.addHabit.timeOfday}
            >
          ...
          <div>
            ...
            <select
              ...
              value={state.addHabit.startDate}
            >
